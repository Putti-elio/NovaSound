...
use novasound_server::adapters::connect::create_connect_router;
use novasound_server::state::AppState;
use novasound_storage_postgres::database::init_database;
...
async fn main() -> anyhow::Result<()> {
    ...
    let app = Router::new()
        .nest("/web", novasound_server::web::router())

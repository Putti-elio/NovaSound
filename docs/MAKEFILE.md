i# Makefile Documentation

> _Auto-generated by [makefile2doc](https://github.com/Merlin-Clos/makefile2doc)_
...
| [`make delete-backend`](#delete)   | Delete   | Delete backend container and image         |
| [`make delete-vuejs`](#delete)     | Delete   | Delete frontend container and image        |
| [`make delete-all`](#delete)       | Delete   | Delete all containers and images           |
| [`make test`](#test)               | Test     | Run backend tests                          |
| [`make prod`](#prod)               | Prod     | Build and run backend in production mode   |
...
| Command               | Description                         | Dependencies | Required Variables |
| :-------------------- | :---------------------------------- | :----------- | :----------------- |
| `make delete-backend` | Delete backend container and image  | -            | -                  |
| `make delete-vuejs`   | Delete frontend container and image | -            | -                  |
| `make delete-all`     | Delete all containers and images    | -            | -                  |
...
| Command     | Description                              | Dependencies | Required Variables |
| :---------- | :--------------------------------------- | :----------- | :----------------- |
| `make prod` | Build and run backend in production mode | -            | -                  |
